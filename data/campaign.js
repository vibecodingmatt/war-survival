...
export const WORLDS = [
  {name:'ASHEN CROSSING',biome:'jungle',sky:'#608e9c',horizon:'#f5ddb1',fog:'#b9c6b6',sun:'#ffd6a0',stone:'#c0bca8',leaf:'#93ac69',water:'#367b78',accent:'#e9c883',weather:'pollen',landmark:'falls',description:'Sunlit gorge · A mossback tortoise and butterfly falls',boss:'warden'},
  ...
  {name:'CLOCKWORK GARDENS',biome:'clockwork',sky:'#315459',horizon:'#edcc9c',fog:'#abb3a0',sun:'#ffdda8',stone:'#baa887',leaf:'#88c49d',water:'#3d8d82',accent:'#a5ffda',weather:'pollen',landmark:'gears',description:'Overgrown machines · A brass owl watches the turning gears',boss:'clockwork'},
