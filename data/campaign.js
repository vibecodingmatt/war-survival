...
export const WORLDS = [
  ...
  {name:'CLOCKWORK GARDENS',biome:'clockwork',sky:'#315459',horizon:'#edcc9c',fog:'#abb3a0',sun:'#ffdda8',stone:'#baa887',leaf:'#88c49d',water:'#3d8d82',accent:'#a5ffda',weather:'pollen',landmark:'gears',description:'Overgrown machines · Turning gears and clockwork dragonflies',boss:'clockwork'},
