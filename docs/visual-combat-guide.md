...
| `js/world/living-worlds.js` | New gardens, portrait landmarks, wildlife, ribbons and shafts |
...
| --- | --- |
| Ashen / Jade | Orchids and lilies, butterflies or spirit koi, waterfall rainbows |
| Ember / Amber | Emberglass, lantern flights, festival kites and gold currents |
| Frostglass / Tempest | Frost crystals, ice/lightning moths, halo arcs and vortices |
| Sunscar / Cinder | Amber geodes, desert kites, molten seams and lava fountains |
| Lumen / Moonlotus | Spore flowers, moon moths, lotus terraces and spirit koi |
| Sky Citadel / Prismatic | Cloud opals, gliders, prism shoals and orbital filaments |
| Coral | Anemones, jewel-fish schools and caustic shafts |
| Clockwork | Mechanical daisies, brass swallowtails and escapement rings |
| Observatory | Constellation gardens, comet migrations and nearby astrolabes |
