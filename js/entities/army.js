...
import { formation } from '../core/math.js?v=0.7.2';
import { MAX_SQUAD } from '../../data/waves.js?v=0.7.2';
import { WEAPON_LIBRARY } from '../../data/campaign.js?v=0.7.2';
import { createBosses } from './bosses.js?v=0.7.2';
